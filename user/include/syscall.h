...
#define SYSCALL1(sysnum, a0) (do_user_syscall((sysnum), (a1), 0, 0, 0, 0, 0, 0, 0))
...
#define COUNT_ARG_R(a7, a6, a5, a4, a3, a2, a1, a0, res, ...) res
#define COUNT_ARG(...) COUNT_ARG_R(__VA_ARGS__,8, 7, 6, 5, 4, 3, 2, 1, 0)

#define CAT_R(a,b) a##b
#define CAT(a,b) CAT_R(a, b)

#define syscall(sysnum, ...) CAT(SYSCALL, COUNT_ARG(__VA_ARGS__)) (sysnum, __VA_ARGS__)
#endif